function help(command) {   
    ...
    switch(command) {    
        ...
        case 'honbux':
            return `**h.daily** to daily Honbux | **h.cfbux** to bet honbux on a coin flip! Type a number to bet and then 'tails' or 'heads' to bet on the result. | **h.honbalance** to check your balance.`
